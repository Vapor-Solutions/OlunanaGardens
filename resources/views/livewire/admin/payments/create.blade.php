...
<div>
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form action="#" wire:submit.prevent="save" wire:ignore>
                    @csrf
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="mb-5">
                                <label for="client" class="form-label">Event Type</label>
                                <select class="form-control" wire:model.live="selectedEventType" name="client"
                                    id="">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <select wire:model="selectedPackage" class="form-control" name="package_id"
                                    id="package_id">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-5">
                                ...
                                <select class="form-control" wire:model="payment_method_id" name="client"
                                    id="">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-5">
                                ...
                                <input type="number" min="1" step="0.05" wire:model="selectedPrice"
