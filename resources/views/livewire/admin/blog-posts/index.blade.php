        ...
        <div class="col-md-3 col-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-danger" onclick="confirm('Are you sure you want to delete this post?') || event.stopImmediatePropagation()" wire:click="delete({{ $post->id }})">Delete</button>
                </div>
            </div>
        </div>
        @endforeach
